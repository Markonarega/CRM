...
<button           className='bg-blue-950  hover: shadow-black text-white px-4 py-2 rounded-lg 
          flex items-center 'onClick={()=>setIsModalOpen(true)}>+ Add Task</button>
      </div>
      {/* tasks lists  */}
...
<option value="Completed">Completed</option>
      ...
      <td className='px-6 py-4 whitespace-nowrap text-sm font-medium'>
        <button className='text-gray-800 hover:text-white'>Edit</button>
        <button className='text-red-600 hover:text-black'>Delete</button>
      </td>
    </tr>
  )
})}
      ...
      {/* adding task Modal  */}
      {isModalOpen &&(
        <div className='fixed inset-0 bg-white bg-opacity-50 flex
